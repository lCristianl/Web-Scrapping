...
export function SenescytPage() {
  ...
  const onSubmit = (data: FormData) => {
    ...
    setResult(
      hasResults
        ? `Información académica encontrada para cédula ${data.cedula}: Título registrado - Ingeniero en Sistemas, Universidad Central del Ecuador, 2020.`
        ...
        <div className="max-w-2xl mx-auto">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Verifica títulos académicos registrados en la Secretaría de Educación Superior.
              </CardDescription>
            </CardHeader>
            <CardContent>
